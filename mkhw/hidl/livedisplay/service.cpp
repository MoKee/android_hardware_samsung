...
#define LOG_TAG "mokee.livedisplay@2.0-service.samsung-qcom"
#else
#define LOG_TAG "vendor.mokee.livedisplay@2.0-service.samsung-qcom"
#endif
...
using vendor::mokee::livedisplay::V2_0::samsung::DisplayColorCalibration;
using vendor::mokee::livedisplay::V2_0::samsung::DisplayModes;
using vendor::mokee::livedisplay::V2_0::samsung::ReadingEnhancement;
using vendor::mokee::livedisplay::V2_0::samsung::SunlightEnhancement;
