...
#define LOG_TAG "mokee.livedisplay@2.0-service.samsung-exynos"
#else
#define LOG_TAG "vendor.mokee.livedisplay@2.0-service.samsung-exynos"
#endif
...
using vendor::mokee::livedisplay::V2_0::samsung::AdaptiveBacklight;
using vendor::mokee::livedisplay::V2_0::samsung::DisplayColorCalibrationExynos;
using vendor::mokee::livedisplay::V2_0::samsung::DisplayModes;
using vendor::mokee::livedisplay::V2_0::samsung::ReadingEnhancement;
using vendor::mokee::livedisplay::V2_0::samsung::SunlightEnhancementExynos;
