...
#define LOG_TAG "vendor.mokee.touch@1.0-service.samsung"
...
using ::vendor::mokee::touch::V1_0::samsung::GloveMode;
using ::vendor::mokee::touch::V1_0::samsung::KeyDisabler;
using ::vendor::mokee::touch::V1_0::samsung::StylusMode;
using ::vendor::mokee::touch::V1_0::samsung::TouchscreenGesture;
